...
- **FEEDBACK_FOO.md for meta-observations:** Separate from runtime artifacts. Captures process issues, instruction gaps, tooling friction about the system itself. Tagged by category.
