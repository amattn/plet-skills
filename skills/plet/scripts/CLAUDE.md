...
- **Never prefix with `python3`:** Call scripts directly via path: `"$PLET_SCRIPTS_DIR/iter_state.py" ...`, NOT `python3 "$PLET_SCRIPTS_DIR/iter_state.py" ...`. The `python3` prefix bypasses the allowed-tools pattern and triggers permission prompts
