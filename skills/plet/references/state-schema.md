...
- **Patch** (1.0.0 → 1.0.1): New optional fields with defaults — fully backward compatible
- **Minor** (1.0.1 → 1.1.0): New required fields or structural additions — auto-migratable
- **Major** (1.1.0 → 2.0.0): Removed or renamed fields — breaking change, requires manual migration
