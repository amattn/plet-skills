...
| ID | Requirement | Priority |
|----|-------------|----------|
| INV_RUN_CMD_1 | Usage: `invoke.py run <plet_dir> --iter-id ITR_xxx --phase implement|verify --cwd <worktree_path> [--max-budget N] [--model MODEL] [--permission-mode MODE] [--dry-run] [--output json [--pretty] [--fields f1,f2]]` | P0 |
