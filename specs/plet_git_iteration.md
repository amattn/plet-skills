...
| GTI_BRN_BHV_6 | Text output is bare branch name (no newline prefix, no "OK —") for easy shell capture: `BRANCH=$(plet_git_iteration.py branch-name plet/state.json --iter-id ID_001)` | P0 |
